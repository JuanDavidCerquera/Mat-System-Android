...
class SInscripcion {
    companion object {
        ...
        val holder = { view: View, fragmentManager: FragmentManager -> HolderInscription/*Holder*/(view,fragmentManager) }
        val url = Urls.urlInscripcion//URL
        val layout = R.layout.item_inscription//Item
            ...
            try {
                val request = JsonObjectRequest(
                    ...
                    { response ->//respuesta correcta
                        ...
                        val recycler: RecyclerView = view.findViewById(R.id.RecyclerInscription/*Recycler*/)
                        recycler.layoutManager = LinearLayoutManager(context)
                        val adapter = object :
                            GenericAdapter<HolderInscription>(data, holder,layout,fragment){}
