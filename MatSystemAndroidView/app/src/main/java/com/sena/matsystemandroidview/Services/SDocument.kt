...
class SDocument {
    companion object {
        ...
        val holder = { view: View, fragmentManager: FragmentManager ->HolderDocument/*Holder*/(view,  fragmentManager)   }
        val url = Urls.urlArchivoUsuario//URL
        val layout = R.layout.item_document//Item
                ...
                val request = JsonObjectRequest(
                    ...
                    { response ->//respuesta correcta
                        ...
                        val recycler: RecyclerView =
                            view.findViewById(R.id.RecyclerDocumentUser/*Recycler*/)
                        recycler.layoutManager = LinearLayoutManager(context)
                        val adapter = object :
                            GenericAdapter<HolderDocument>(data, holder, layout, fragment) {}
