...
class SCourse {
    companion object {
        ...
        val holder = { view: View, fragmentManager: FragmentManager -> HolderCourse/*Holder*/(view,fragmentManager) }
        val url = Urls.urlCursos//URL
        val layout = R.layout.item_course//Item
            ...
            try {
                val request = JsonObjectRequest(
                    ...
                    { response ->//respuesta correcta
                        ...
                        val recycler: RecyclerView = view.findViewById(R.id.RecyclerCourseList/*Recycler*/)
                        recycler.layoutManager = LinearLayoutManager(context)
                        val adapter = object :
                            GenericAdapter<HolderCourse>(data, holder,layout,fragment){}
